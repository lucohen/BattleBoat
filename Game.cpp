...
// that location.
//
// During gameplay, the position of the target boat remains hidden and a wave (tilde character, '~')
...
// /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
/\/\/\/\/\/\/\/\/\/\/\/\/\ //
// // TODO: Assign an 'X' to the grid coordinate of the target boat showing it
// has been sunk.
// // Assign an 'X' character to the location of the target boat within the two-
// dimensional array member
// // variable this->a_cGrid at the location of the target boat given by (this-
// >m_iRowBoat, this->m_iColumnBoat).
// // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
// /\/\/\/\/\/\/\/\/\/\/\/\/\ //
